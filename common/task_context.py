...
class TaskContext:
    ...
    @classmethod
    def from_tasks(cls, tasks: List[TaskDescription], dependencies: Optional[List[TaskDependency]] = None, 
                   request_id: Optional[str] = None, context_id: Optional[str] = None) -> 'TaskContext':
        """
    ...
    def from_checkpoint(cls, checkpoint: Dict) -> 'TaskContext':
        ...
        context.execution_state = ExecutionState(checkpoint.get('execution_state', ExecutionState.IDLE))
    ...
    def get_performance_metrics(self) -> Dict:
        ...
        completed_tasks = len([n for n in self.task_graph.nodes.values() if n.status == TaskStatus.COMPLETED])
    ...
    def __str__(self) -> str:
        ...
        return (f"TaskContext(id={self.context_id}, "
