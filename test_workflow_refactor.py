...
async def test_tool_registry():
    ...
    try:
        ...
        memory_tools = [name for name in tool_registry._tools.keys() if name.startswith('memory.')]
        notification_tools = [name for name in tool_registry._tools.keys() if name.startswith('notification.')]
