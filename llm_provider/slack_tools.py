...
def list_slack_channels(limit: int = 20, types: str = "public_channel") -> Dict[str, Any]:
    """
    ...
    mock_channels = [
        {"id": "C1234567890", "name": "general", "is_private": False, "member_count": 100},
        {"id": "C1234567891", "name": "random", "is_private": False, "member_count": 75},
        {"id": "C1234567892", "name": "development", "is_private": False, "member_count": 25},
        {"id": "C1234567893", "name": "announcements", "is_private": False, "member_count": 150}
    ]
...
def format_slack_message(content: str, formatting: str = "plain") -> Dict[str, Any]:
    ...
    """
    logger.info(f"Formatting Slack message: {len(content)} characters, format: {formatting}")
...
def validate_slack_channel(channel: str) -> Dict[str, Any]:
    ...
    if not channel:
        ...
        if channel.startswith('#'):
            ...
            if len(channel_name) < 1:
                ...
                errors.append("Channel name can only contain letters, numbers, hyphens, and underscores")
    ...
    logger.info(f"Channel validation: {'PASSED' if is_valid else 'FAILED'} with {len(errors)} errors")
    return result
