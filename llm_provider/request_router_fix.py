"""Request Router Module with bug fix for role filtering issue.
...
This version includes a fix for the role filtering bug where the LLM was not
correctly processing all roles in the router prompt.
"""
...
class RequestRouter:
    ...
    def route_request(self, instruction: str) -> dict[str, Any]:
        ...
        try:
            ...
            # FIX: Use STRONG model type for more reliable role processing
...
{{"route": "<role_name_or_PLANNING>", "confidence": <0.0-1.0>}}"""
    ...
    def get_routing_statistics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "llm_type_used": LLMType.STRONG.value,  # FIX: Updated to STRONG
        }
    ...
    def validate_routing_setup(self) -> dict[str, Any]:
        ...
        # Check LLM factory
        try:
            model = self.llm_factory.create_strands_model(
                LLMType.STRONG
            )  # FIX: Use STRONG model
            if model is None:
    ...
    def _build_enhanced_routing_prompt(
        ...
        FIX: Improved prompt structure to ensure all roles are properly processed.
        """
        ...
        # FIX: Improved prompt structure with clearer instructions and examples
...
- Ensure all required parameters are extracted if possible"""
    ...
    def _parse_routing_and_parameters(self, llm_result: str) -> dict[str, Any]:
        ...
        try:
            ...
            # FIX: Better handling of JSON extraction from LLM response
