...
from roles.shared_tools.data_processing import perform_comparative_analysis, generate_insights
...
class TestAnalysisTools:
    ...
    def test_perform_comparative_analysis_basic(self):
        ...
        assert result['size_difference'] == 0  # Both have same string length representation
    ...
    def test_generate_insights_relationships(self):
        ...
        data = {"price": 100, "quantity": 5, "name": "Product A", "category": "Electronics"}
