...
class TestUniversalAgentUnit:
    ...
    def test_tool_registry_integration(self, universal_agent, mock_strands_agent):
        ...
        universal_agent.tool_registry.get_tools.return_value = [mock_tool_1, mock_tool_2]
        ...
        with patch('llm_provider.universal_agent.Agent') as mock_agent_class, \
            ...
            universal_agent.tool_registry.get_tools.assert_called_once_with(["tool1", "tool2"])
    ...
    def test_mcp_client_integration(self, universal_agent, mock_strands_agent):
        ...
        universal_agent.mcp_manager.get_tools_for_role.return_value = [mock_mcp_tool_1, mock_mcp_tool_2]
        ...
        with patch('llm_provider.universal_agent.Agent') as mock_agent_class, \
            ...
            universal_agent.mcp_manager.get_tools_for_role.assert_called_once_with("analysis")
    ...
    def test_execute_task_success(self, universal_agent, mock_strands_agent, sample_task_context):
        ...
        with patch('llm_provider.universal_agent.Agent') as mock_agent_class, \
            ...
            mock_strands_agent.assert_called_once_with("Analyze the data and provide insights")
    ...
    def test_execute_task_with_exception_handling(self, universal_agent, mock_strands_agent):
    ...
    def test_role_specific_prompts(self, universal_agent):
        ...
        test_cases = [
            ...
            ("unknown_role", "helpful AI assistant", "Provide accurate, helpful responses")
        ]
