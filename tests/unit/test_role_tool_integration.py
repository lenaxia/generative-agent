...
class TestRoleToolIntegration:
    ...
    def test_research_analyst_role_has_web_tools(self, role_registry):
        ...
        for tool in expected_tools:
            assert tool in shared_tools, f"Tool '{tool}' not found in research_analyst role"
    ...
    def test_research_role_can_use_scraping(self, mock_bs, mock_requests, universal_agent):
