...
class TestRoleFallbackBehavior:
    ...
    def test_assume_role_with_none_falls_back_to_default(self, universal_agent, mock_task_context):
    ...
    def test_assume_role_with_missing_role_falls_back_to_default(self, universal_agent, mock_task_context):
    ...
    def test_assume_role_with_missing_default_creates_basic_agent(self, mock_llm_factory):
    ...
    def test_basic_agent_creation_with_tools(self, universal_agent):
        ...
        with patch('strands.Agent') as mock_agent_class:
            ...
            result = universal_agent._create_basic_agent(LLMType.DEFAULT, None, ["test_tool"])
