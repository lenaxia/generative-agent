...
class TestContextSwitching:
    ...
    def mock_role_registry(self):
        ...
        timer_role.config = {
            'prompts': {
                'system': 'You are a timer specialist.'
            },
            'tools': {
                'shared': ['timer_tools']
            }
    ...
    def test_assume_role_uses_agent_pooling(self, universal_agent, mock_agent):
        ...
        with patch.object(universal_agent.llm_factory, 'get_agent') as mock_get_agent, \
             patch.object(universal_agent, '_update_agent_context') as mock_update_context:
    ...
    def test_assume_role_determines_correct_llm_type(self, universal_agent, mock_agent):
        ...
        with patch.object(universal_agent.llm_factory, 'get_agent') as mock_get_agent, \
             ...
             patch.object(universal_agent, '_determine_llm_type_for_role') as mock_determine_type:
    ...
    def test_context_switching_updates_agent_properties(self, universal_agent, mock_agent):
        ...
        with patch.object(universal_agent.llm_factory, 'get_agent') as mock_get_agent:
            ...
            assert hasattr(mock_agent, 'system_prompt') or hasattr(mock_agent, 'update_context')
    
    def test_multiple_role_switches_use_same_agent_pool(self, universal_agent, mock_agent):
    ...
    def test_context_switching_performance(self, universal_agent):
        ...
        with patch.object(universal_agent.llm_factory, 'get_agent') as mock_get_agent, \
             patch.object(universal_agent, '_assemble_role_tools') as mock_assemble_tools, \
             patch.object(universal_agent, '_get_system_prompt_from_role') as mock_get_prompt:
