...
class TestPerformanceBenchmarking:
    ...
    def universal_agent(self, factory_with_config, mock_role_registry):
        ...
        return UniversalAgent(
            llm_factory=factory_with_config,
    ...
    def test_weather_query_simulation_performance(self, universal_agent):
        ...
        with patch('llm_provider.factory.BedrockModel'), \
            ...
            router_agent = universal_agent.assume_role("router", LLMType.WEAK)
            
            # Step 2: Weather agent (should use DEFAULT model)  
            weather_agent = universal_agent.assume_role("weather", LLMType.DEFAULT)
...
class TestPerformanceComparison:
    ...
    def test_target_performance_achievement(self):
        ...
        actual_improvement = ((simulated_old_time - simulated_new_time) / simulated_old_time) * 100
        ...
        pooling_contribution = ((agent_creation_overhead_old - agent_pooling_overhead_new) / 
                               (simulated_old_time - simulated_new_time)) * 100
