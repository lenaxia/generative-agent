...
class TestErrorHandlingUnit:
    ...
    def test_task_context_corrupted_checkpoint(self):
        ...
        with pytest.raises(ValueError, match="Invalid checkpoint data: missing task_graph_state"):
    ...
    def test_message_bus_communication_failure(self, workflow_engine):
        ...
        workflow_engine.message_bus.subscribe.side_effect = Exception("Message bus connection failed")
