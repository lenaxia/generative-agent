        ...
        try:
            ...
            with (
                ...
                mock_summarize_text.return_value = {
                    "summary": "This is a summary about testing in software development.",
                    "status": "success",
                    "word_count": 10,
                }
                ...
                # Test summarize_text
                summary = mock_summarize_text(long_text, max_length=100)
                ...
                assert (
                    "testing" in summary_text.lower() or "test" in summary_text.lower()
                )
