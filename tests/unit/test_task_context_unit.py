...
class TestTaskContextUnit:
    ...
    def test_conversation_history_management(self, task_context):
        ...
        task_context.add_assistant_message("Assistant: I'll help you create a project plan")
        task_context.add_system_message("System: Task execution started")
        task_context.add_user_message("User: What's the first step?")
        task_context.add_assistant_message("Assistant: Let's start by defining requirements")
    ...
    def test_metadata_management(self, task_context):
        ...
        assert task_context.get_metadata("nonexistent", "default_value") == "default_value"
    ...
    def test_invalid_checkpoint_handling(self):
        ...
        with pytest.raises(ValueError, match="Invalid checkpoint: must be a dictionary"):
