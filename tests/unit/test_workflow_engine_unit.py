...
from supervisor.workflow_engine import WorkflowEngine, WorkflowState, TaskPriority, QueuedTask
...
class TestWorkflowEngineUnit:
    ...
    def mock_universal_agent(self):
        ...
        agent.execute_task.return_value = {"result": "success", "output": "Task completed"}
        return agent
    ...
    def test_start_workflow_success(self, workflow_engine):
        ...
        with patch.object(workflow_engine, '_create_task_plan') as mock_create_plan:
            ...
            with patch.object(workflow_engine, '_execute_dag_parallel') as mock_execute_dag:
                # Execute
