    ...
    def mock_execute_side_effect(instruction, role, llm_type, context=None):
        ...
        if role == "router":
            ...
            if "user request:" in instruction_lower:
                ...
                user_request_end = instruction_lower.find(
                    "options:", user_request_start
                )
            ...
            elif "plan" in user_request and (
                "comprehensive" in user_request
                or "multiple" in user_request
                or "phases" in user_request
            ):
