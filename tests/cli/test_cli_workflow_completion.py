...
"""
    ...
    def test_workflow_completion_detection_bug(
        self, mock_get_status, mock_start_workflow
    ):
        ...
        try:
            ...
            assert correct_completion_check is True  # Workflow is actually completed
    ...
    def test_cli_completion_logic_simulation(self, mock_execute):
        ...
        assert fixed_result is True  # Fixed: correctly detects completion
