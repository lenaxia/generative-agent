...
class TestHybridExecutionIntegration:
    ...
    def test_hybrid_execution_architecture_integration(self, mock_llm_factory, message_bus):
        ...
        assert universal_agent.get_role_type("analysis") == "llm"  # Default for unknown roles
    ...
    def test_workflow_engine_uses_hybrid_execution(self, mock_llm_factory, message_bus):
        ...
        with patch.object(universal_agent, 'execute_task', return_value="test result") as mock_execute:
            # Test programmatic execution
            result = universal_agent.execute_task(
                instruction="Search for USS Monitor",
                role="search_data_collector"
            )
    ...
    def test_backward_compatibility_with_existing_roles(self, mock_llm_factory, message_bus):
    ...
    def test_hybrid_architecture_performance_benefits(self, mock_llm_factory, message_bus):
