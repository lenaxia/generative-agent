...
class TestFastPathRoutingIntegration:
    ...
    def test_fast_path_weather_query_integration(self, workflow_engine, mock_llm_factory, mock_llm_execution):
    ...
    def test_fast_path_calendar_query_integration(self, workflow_engine, mock_llm_execution):
    ...
    def test_fast_path_timer_query_integration(self, workflow_engine, mock_llm_execution):
    ...
    def test_fast_path_smart_home_query_integration(self, workflow_engine, mock_llm_execution):
    ...
    def test_complex_workflow_fallback_integration(self, workflow_engine, mock_planning_phase):
        ...
        assert result not in workflow_engine.fast_reply_results  # Not stored as fast reply
    
    def test_low_confidence_fallback_integration(self, workflow_engine, mock_planning_phase):
    ...
    def test_fast_path_error_fallback_integration(self, workflow_engine, mock_planning_phase):
    ...
    def test_fast_path_disabled_integration(self, mock_llm_factory, mock_message_bus, mock_planning_phase):
...
class TestFastPathRoutingPerformance:
    ...
    def test_fast_path_response_time_benchmark(self, workflow_engine_perf, mock_llm_execution):
    ...
    def test_concurrent_fast_path_requests(self, workflow_engine_perf, mock_llm_execution):
...
class TestFastPathRoutingEdgeCases:
    ...
    def test_malformed_routing_response_integration(self, mock_llm_execution, mock_planning_phase):
    ...
    def test_unknown_role_routing_integration(self, mock_llm_execution, mock_planning_phase):
