...
async def validate_location(instruction: str, context: TaskContext, 
                          parameters: Dict) -> Dict[str, Any]:
    """
...
async def pii_scrubber(llm_result: str, context: TaskContext, 
                     pre_data: Dict) -> str:
    """
    ...
    try:
        ...
        scrubbed_result = re.sub(precise_coord_pattern, '[coordinates removed]', scrubbed_result)
