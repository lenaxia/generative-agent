...
ROLE_CONFIG = {
    ...
    "llm_type": "DEFAULT",
    "fast_reply": True,
    "when_to_use": "Summarize results, create reports, synthesize information from multiple sources, present findings, create structured outputs, consolidate task results, generate itineraries or plans",
    "parameters": {
        "format": {
            "type": "string",
            "required": False,
