...
Updated to remove rule-based routing for better performance.
"""
...
ROLE_CONFIG = {
    ...
    "llm_type": "STRONG",  # Updated to STRONG for better routing accuracy
...
def register_role():
    ...
    return {
        ...
        "tools": [],  # Removed rule-based routing tools for better performance
        "intents": {
